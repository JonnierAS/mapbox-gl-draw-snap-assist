...
import { pixelDistance, bboxFromCursor, extractVertices, extractSegments, isValidCoord } from './CoordUtils'
...
export class SnapEngine {
   ...
   */
  private getCandidates(cursor: Position, excludeFeatureId?: string): Feature[] {
    if (this.options.snapGetFeatures) {
      return this.options.snapGetFeatures(this.map, cursor, this.options.snapPx)
    }
